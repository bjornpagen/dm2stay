      ...
      <Card className="transition-all duration-200 ease-in-out hover:scale-[1.02] hover:shadow-lg">
        <div className="flex h-[240px]">
          <div className="relative w-[320px] min-w-[320px]">
            <Image src={image || "/placeholder.svg"} alt={name} fill className="object-cover rounded-l-lg" />
            {inquiries > 0 && (
            ...
            <div className="flex justify-between h-full">
              <div className="space-y-2">
                ...
                <div className="mt-auto">
                  <p className="text-sm font-medium mb-1">Conversion Rate: {(conversionRate * 100).toFixed(1)}%</p>
