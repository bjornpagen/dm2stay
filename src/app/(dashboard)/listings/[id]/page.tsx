    ...
    reviews: [
      {
        ...
        reviewer: {
          name: "Kaveh",
          photo: "https://a0.muscache.com/im/users/238828/profile_pic/1284862687/original.jpg",
        },
        date: "April 2023",
        rating: 5,
        comment:
      ...
      },
      {
        ...
        reviewer: {
          name: "Maria",
          photo: "https://a0.muscache.com/im/users/7919941/profile_pic/1376202256/original.jpg",
        },
        date: "March 2023",
        rating: 5,
        comment:
      ...
      },
      {
        ...
        reviewer: {
          name: "James",
          photo: "https://a0.muscache.com/im/pictures/user/b8469367-3779-4aa1-910a-88377fc2fcdc.jpg",
        },
        date: "February 2023",
        rating: 4,
        comment:
  ...
  return (
    <div className="w-full space-y-8">
      ...
      <section className="-mx-6 -mt-6">
        <Suspense>
          {listing.data.gallery && <ListingGallery gallery={listing.data.gallery} />}
        </Suspense>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <Suspense>
            {listing.data.overview && <ListingHeader overview={listing.data.overview} />}
            {listing.data.description && <ListingDescription description={listing.data.description} />}
            {listing.data.amenities && <ListingAmenities amenities={listing.data.amenities} />}
            {listing.data.location && <ListingLocation location={listing.data.location} />}
            {listing.data.reviews && listing.data.reviews.length > 0 && <ListingReviews reviews={listing.data.reviews} />}
          </Suspense>
        </div>

        {/* Right Column - Analytics & Policies */}
        <div className="space-y-8">
          <Suspense>
            <ListingAnalytics listingId={id} />
            {listing.data.policies && <ListingPolicies policies={listing.data.policies} />}
          </Suspense>
        </div>
      </div>
    </div>
